...
export const BusinessRegistrationFlow: React.FC<BusinessRegistrationFlowProps> = ({
  ...
  const renderSelectMethod = () => (
    <div className="animate-in slide-in-from-right duration-300 pt-4">
      ...
      <p className="text-gray-500 text-sm mb-6">
        Precisamos garantir que você é o proprietário. Escolha como deseja receber o código de
        verificação:
      </p>
  ...
  const renderManualVerify = () => (
    <div className="animate-in slide-in-from-right duration-300 pt-4">
      ...
      <p className="text-gray-500 text-sm mb-6">
        Não conseguimos verificar automaticamente. Por favor, envie um documento que comprove a
        propriedade da loja (Ex: Contrato Social, Cartão CNPJ ou Conta de Luz).
      </p>
