...
const PRIZES: Prize[] = [
  {
    prize_key: 'reais_5',
    prize_label: 'R$5 de Volta',
    prize_type: 'cashback',
    prize_value: 5,
    status: 'creditado',
    color: '#FFFFFF',
    textColor: '#1749CC',
    description: 'Creditado na sua carteira Cashback Local.',
  },
  {
    ...
    color: '#1E5BFF',
    textColor: '#FFFFFF',
    description: 'Válido na próxima compra em parceiros.',
  },
  {
    prize_key: 'lose',
    prize_label: 'Não foi dessa vez',
    prize_type: 'nao_foi_dessa_vez',
    status: 'nao_aplicavel',
    color: '#FFFFFF',
    textColor: '#1749CC',
    description: 'Mais sorte amanhã!',
  },
  {
  ...
  },
  {
    ...
    prize_type: 'gire_de_novo',
    status: 'nao_aplicavel',
    color: '#FFFFFF',
    textColor: '#1749CC',
    description: 'Boa sorte na próxima tentativa!',
  },
  {
    prize_key: 'reais_10',
    prize_label: 'Cupom R$10',
    prize_type: 'cupom',
    prize_value: 10,
    status: 'pendente',
    color: '#1E5BFF',
    textColor: '#FFFFFF',
    description: 'Use em qualquer loja parceira.',
  },
  {
    prize_key: 'gift_local',
    prize_label: 'Brinde Local',
    prize_type: 'cupom',
    status: 'pendente',
    color: '#FFFFFF',
    textColor: '#1749CC',
    description: 'Apresente o código para retirar.',
  },
  {
    prize_key: 'cashback_15',
    prize_label: '15% Cashback',
    prize_type: 'cashback',
    prize_value: 15,
    status: 'creditado',
    color: '#1E5BFF',
...
export const SpinWheelView: React.FC<SpinWheelViewProps> = ({
  ...
  const handleSpin = () => {
    ...
    setTimeout(() => {
      ...
      if (prize.prize_type !== 'nao_foi_dessa_vez') {
        onWin(prize);
      }
    }, 1800);
  };
            ...
            {currentPrize && (
              <div className="mt-1 rounded-2xl bg-white/5 border border-white/10 px-3 py-2">
                ...
                <p className="text-[12px]">
                  {currentPrize.prize_type === 'nao_foi_dessa_vez'
