...
export const CATEGORIES: Category[] = [
  // Top 8 Categories ordered as requested
  {
    ...
    name: "Saúde",
    slug: "health",
    icon: <Heart className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "2",
    name: "Profissionais",
    slug: "pros",
    icon: <Briefcase className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "new-1",
    name: "Beleza",
    slug: "beauty",
    icon: <Scissors className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "new-6",
    name: "Autos",
    slug: "autos",
    icon: <CarFront className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "7",
    name: "Pets",
    slug: "pets",
    icon: <Dog className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "8",
    name: "Casa",
    slug: "home-decor",
    icon: <Armchair className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "new-5",
    name: "Esportes",
    slug: "sports",
    icon: <Dumbbell className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "new-7",
    name: "Assistências",
    slug: "assistance",
    icon: <Wrench className="w-6 h-6 text-[#2D6DF6]" />,
  },
  ...
  // Remaining categories
  {
    ...
    name: "Alimentação",
    slug: "food",
    icon: <Utensils className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "new-3",
    name: "Educação",
    slug: "education",
    icon: <GraduationCap className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "new-4",
    name: "Serviços",
    slug: "services",
    icon: <Settings className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "new-8",
    name: "Bem-estar",
    slug: "wellness",
    icon: <Sun className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "3",
    name: "Festas",
    slug: "party",
    icon: <PartyPopper className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "4",
    name: "Moda",
    slug: "fashion",
    icon: <Shirt className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "5",
    name: "Mercados",
    slug: "grocery",
    icon: <Coffee className="w-6 h-6 text-[#2D6DF6]" />,
  },
  {
    id: "6",
    name: "Condomínios",
    slug: "condos",
    icon: <Building2 className="w-6 h-6 text-[#2D6DF6]" />,
  },
];
...
> = {
  Alimentação: [
    ...
    { name: "Delivery", icon: <Bike className="w-8 h-8 text-[#1B54D9]" /> },
    {
      ...
      icon: <Beer className="w-8 h-8 text-[#1B54D9]" />,
    },
  ...
  Saúde: [
    ...
    { name: "Psicólogos", icon: <Brain className="w-8 h-8 text-[#1B54D9]" /> },
    {
      ...
      icon: <Activity className="w-8 h-8 text-[#1B54D9]" />,
    },
  ...
  Educação: [
    ...
    {
      name: "Curso profissionalizantes",
      icon: <Briefcase className="w-8 h-8 text-[#1B54D9]" />,
    },
  ...
  Serviços: [
    ...
    {
      name: "Eletro domestico",
      icon: <Plug className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  Esportes: [
  ...
  Autos: [
    {
      name: "Oficina Mecânica & Autoelétrica",
      icon: <Wrench className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Funilaria & Pintura",
      icon: <PaintRoller className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Lava-Jato & Estética Automotiva",
      icon: <Sparkles className="w-8 h-8 text-[#1B54D9]" />,
    },
    { name: "Pneus", icon: <CircleDashed className="w-8 h-8 text-[#1B54D9]" /> },
    {
      name: "Alinhamento & Suspensão",
      icon: <Activity className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Autopeças & Acessórios",
      icon: <Settings className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Vidro, Películas & Insulfilm",
      icon: <Sun className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Chaveiro automotivo",
      icon: <Key className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Documentão & Despachantes",
      icon: <FileText className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  Profissionais: [
  ...
  Pets: [
    {
      name: "Pet Shop & Acessórios",
      icon: <ShoppingBag className="w-8 h-8 text-[#1B54D9]" />,
    },
    { name: "Banho & Tosa", icon: <Scissors className="w-8 h-8 text-[#1B54D9]" /> },
    {
      name: "Veterinários & Clínicas",
      icon: <Stethoscope className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Hospedagem & Daycare",
      icon: <Home className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Adestramento",
      icon: <GraduationCap className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Farmácia Pet & Suplementos",
      icon: <Pill className="w-8 h-8 text-[#1B54D9]" />,
    },
    { name: "Alimentação Pet", icon: <Bone className="w-8 h-8 text-[#1B54D9]" /> },
    {
      name: "Serviços Especias",
      icon: <Sparkles className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  Assistências: [
    ...
    { name: "Micro-ondas", icon: <Zap className="w-8 h-8 text-[#1B54D9]" /> },
    {
      ...
      icon: <Waves className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  "Bem-estar": [
    {
      name: "Massoterapia & Relaxamento",
      icon: <Heart className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
    ...
    {
      name: "Clinicas de Estéticas",
      icon: <Sparkles className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Psicologia & Terapia",
      icon: <Brain className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Nutrição & Vida Saudável",
      icon: <Apple className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Yoga & meditação",
      icon: <Sun className="w-8 h-8 text-[#1B54D9]" />,
    ...
    {
      name: "Spa, Day Spa & Terapia",
      icon: <Droplet className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  Festas: [
    {
      name: "Decoração & Ambientação",
      icon: <Sparkles className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Buffet & Gastronomia",
      icon: <Utensils className="w-8 h-8 text-[#1B54D9]" />,
    },
    { name: "Salões & Espaços", icon: <Home className="w-8 h-8 text-[#1B54D9]" /> },
    {
      name: "Dj, Músicas & entretenimento",
      icon: <Music className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Aluguel de Equipamentos",
      icon: <Tv className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Fotografia & Filmagem",
      icon: <Camera className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Bolos, Doces & Personalizados",
      icon: <Croissant className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Personagens & animação",
      icon: <Smile className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  Moda: [
    {
    ...
    {
      name: "Moda Infantil & Bebê",
      icon: <Baby className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Moda Praia & fitness",
      icon: <Sun className="w-8 h-8 text-[#1B54D9]" />,
    },
    { name: "Calçados", icon: <Footprints className="w-8 h-8 text-[#1B54D9]" /> },
    {
      name: "Acessórios & Bijuterias",
      icon: <Gem className="w-8 h-8 text-[#1B54D9]" />,
    },
    { name: "Joias & Relógios", icon: <Watch className="w-8 h-8 text-[#1B54D9]" /> },
    {
      name: "Moda Íntima & Sleepwear",
      icon: <Moon className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  Condomínios: [
    {
      name: "Segurança Patrimonial",
      icon: <ShieldCheck className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
    ...
    },
    {
      ...
      icon: <Hammer className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Piscina & Guardião",
      icon: <Waves className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Jardinagem & Paisagismo",
      icon: <Leaf className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Fornecedores & Suprimentos",
      icon: <Package className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Administração de Condomínios",
      icon: <Building2 className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Portaria & controle de Acesso",
      icon: <UserCheck className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  Casa: [
    {
      name: "Decoração & Design de Interiores",
      icon: <Palette className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Móveis & Planejados",
      icon: <Armchair className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Iluminação & elétrica",
      icon: <Lightbulb className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
    ...
    },
    {
      ...
      icon: <BrickWall className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
    ...
    {
      name: "Chaveiro Residencial",
      icon: <Key className="w-8 h-8 text-[#1B54D9]" />,
    },
    {
      name: "Limpeza Residencial & Diaristas",
      icon: <Sparkles className="w-8 h-8 text-[#1B54D9]" />,
    },
  ],
  default: [
...
/**
 * STORIES / CANAIS / LOJAS / LEADS / TRANSAÇÕES
 */
    ...
    reviews: [
      {
        ...
        user: "Maria S.",
        rating: 5,
        text: "Melhor loja de produtos naturais!",
        date: "Há 2 dias",
      },
      {
        id: "r2",
...
export const LEADS: ServiceLead[] = [
  ...
  {
    id: "3",
    title: "Troca de Fiação Elétrica",
    category: "Eletricista",
    urgency: "Alta",
    priceToUnlock: 3.9,
    maskedName: "Roberto S.",
    district: "Freguesia",
  },
];
...
/**
 * 🔸 quickFilters usados pelo ExploreView
 */
export type QuickFilter = {
  id: string;
  label: string;
  icon?: "zap" | "star" | "clock" | "percent";
};

export const quickFilters: QuickFilter[] = [
  { id: "nearby", label: "Perto de você", icon: "clock" },
...
/**
 * 🔸 featuredStores (pra qualquer componente que ainda use)
 */
export const featuredStores: Store[] = STORES.filter(
  (s) => s.adType === AdType.PREMIUM || s.adType === AdType.LOCAL
);
