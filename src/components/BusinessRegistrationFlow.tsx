...
// Mock Data para simular loja existente
...
export const BusinessRegistrationFlow: React.FC<
...
> = ({ onBack, onComplete }) => {
  ...
  const renderNotFound = () => (
    <div className="animate-in slide-in-from-right duration-300 flex flex-col items-center text-center pt-8">
      ...
      <p className="text-gray-500 dark:text-gray-400 text-sm mb-8 max-w-xs">
        O CNPJ informado não consta na nossa base. Vamos criar um novo cadastro
        do zero para você.
      </p>
      <button
        onClick={() => onComplete()}
    ...
    <div className="animate-in slide-in-from-right duration-300 pt-4">
      <div className="bg-[#EAF0FF] dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-2xl p-4 flex gap-3 items-start mb-6">
        ...
        <p className="text-xs text-blue-800 dark:text-blue-200 leading-relaxed">
          Esta loja já está cadastrada no Localizei Freguesia. Para administrar
          o perfil, você precisa reivindicar a propriedade.
        </p>
      </div>
  ...
  const renderSelectMethod = () => (
    <div className="animate-in slide-in-from-right duration-300 pt-4">
      ...
      <p className="text-gray-500 text-sm mb-6">
        Precisamos garantir que você é o proprietário. Escolha como deseja
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-200 dark:border-gray-700 flex items-center gap-4 hover:border-green-500 transition-colors shadow-sm group"
        >
        ...
        <button
          ...
          className="w-full bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-200 dark:border-gray-700 flex items-center gap-4 hover:border-[#1E5BFF] transition-colors shadow-sm group"
        >
  ...
  const renderOtp = () => (
    <div className="animate-in slide-in-from-right duration-300 pt-8 flex flex-col items-center">
      ...
      <div className="mt-6 flex flex-col gap-3 items-center">
        <button className="text-xs font-bold text-[#1E5BFF]">
          Reenviar código
        </button>
        <button
          onClick={() => setStep('manual_verify')}
  ...
  const renderManualVerify = () => (
    <div className="animate-in slide-in-from-right duration-300 pt-4">
      ...
      <p className="text-gray-500 text-sm mb-6">
        Não conseguimos verificar automaticamente. Por favor, envie um documento
        que comprove a propriedade da loja (Ex: Contrato Social, Cartão CNPJ ou
        Conta de Luz).
      </p>
